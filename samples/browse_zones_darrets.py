#!/usr/bin/env python3
"""Browse the zones-d-arrets dataset.
...
# running this script directly (e.g. `python samples/browse_zones_darrets.py`).
...
def main():
    parser = argparse.ArgumentParser(description="Browse zones-d-arrets dataset")
    parser.add_argument("--search", default=None, help="Filter records by name substring")
    ...
    records = load_dataset("zones-d-arrets")
    if not records:
