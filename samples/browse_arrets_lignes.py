#!/usr/bin/env python3
"""Browse the arrets-lignes dataset (stop-line associations).
...
Usage:
    ...
    uv run python samples/browse_arrets_lignes.py --search "Métro 1"
    uv run python samples/browse_arrets_lignes.py --search "Châtelet" --limit 10
"""
...
def main():
    parser = argparse.ArgumentParser(description="Browse arrets-lignes dataset")
